...
public class Assertion_Test  {
	...
	//After login assertion
		...
		//Business registration page assertion
				...
				//invitepageassert assert
				public static  String Ex_invitepageassert;
				public static  String Act_invitepageassert;
				public  void invitepageassert()  throws Exception 
				{ 
					//System.out.println(Ex_home=td.get_string_CellData("Assertion", 0, 0));
					Act_invitepageassert=Robj.invitepageassert().getText();
					Ex_invitepageassert="Discover Great Food Recommendations From People You Know";
					Assert.assertEquals(Act_invitepageassert,Ex_invitepageassert);
					System.out.println("	# Validation == PASS :: 'Discover Great Food Recommendations From People You Know' Text is present");		
				}
}