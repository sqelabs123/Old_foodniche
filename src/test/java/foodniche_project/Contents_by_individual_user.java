...
//	public String userId = "asian.recipes.user@foodniche.me";
...
//	public static final String URL = "https://" + USERNAME + ":" + AUTOMATE_KEY + "@hub-cloud.browserstack.com/wd/hub";
	...
	public void Posting_Pictures_Contents_by_Individual_User(String userId,String password,String url, String USERNAME, String AUTOMATE_KEY) throws Exception
	{
...
//		System.setProperty("webdriver.chrome.driver", exePath);
		  ...
		  DesiredCapabilities caps = new DesiredCapabilities();
		    ...
		    caps.setCapability("build", "Individual User Contents");
