...
public class Groups_by_business{
...
//	public static final String URL = "https://" + USERNAME + ":" + AUTOMATE_KEY + "@hub-cloud.browserstack.com/wd/hub";
	...
	@Parameters({"userId","password","url","USERNAME","AUTOMATE_KEY"})
		public void Posting_Picture_by_Business_User(String userId,String password,String url, String USERNAME, String AUTOMATE_KEY) throws Exception { 
		DesiredCapabilities caps = new DesiredCapabilities();
		    ...
		    caps.setCapability("build", "Business User Group");
...
*/		
		...
		//Entering name
		action_obj.groupname().sendKeys("Asian Recipes");
